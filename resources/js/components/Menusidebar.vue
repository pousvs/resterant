            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <router-link to="/homes" class="menu-link">
                        <i class='menu-icon bx bxs-home-alt-2'></i>
                        <div>ໜ້າຫລັກ</div>
                    </router-link>
                </li>

                <li class="menu-item">
                    <router-link to="/tables" class="menu-link">
                        <i class='menu-icon bx bx-chair'></i>
                        <div>ເລກໂຕະ</div>
                    </router-link>
                </li>

                <li class="menu-item">
                    <router-link to="/ppdet" class="menu-link">
                        <i class='menu-icon bx bxs-folder-open'></i>
                        <div>ປະເພດອາຫານ</div>
                    </router-link>
                </li>
                ...
                <li class="menu-item">
                    <router-link to="/pos" class="menu-link">
                        <i class='menu-icon bx bxs-dish'></i>
                        <div>ສັ່ງອາຫານ</div>
                    </router-link>
                </li>

                <li class="menu-item">
                    <router-link to="/storecal" class="menu-link">
                ...
                <li class="menu-item">
                    <router-link to="/transection" class="menu-link">
                        <i class='menu-icon bx bxs-bar-chart-square'></i>
