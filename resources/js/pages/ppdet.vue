<template>
    <div class="card">
        <h5 class="card-header">ລາຍການ ປະເພດອາຫານ</h5>
        <div class="card-body">
            ...
            <div v-if="ShowForm">
                ...
                <div class="row">
                    <div class=" col-md-8">
                        <div>
                            <label class="form-label fs-6">ປະເພດອາຫານ: <span class="text-danger">*</span></label>
                ...
                <table class="table table-bordered">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th class="text-center">ປະເພດອາຫານ</th>
...
export default {
    ...
    methods: {
        ...
        SaveStore() {
            if (this.FormType) {
                axios.post('api/ProList/add', this.FormStore, { headers: { "content-type": "multipart/form-data", Authorization: 'Bearer ' + this.store.get_token } }).then((res) => {
                ...
                axios.post(`api/ProList/update/${this.EditID}`, this.FormStore, { headers: { Authorization: 'Bearer ' + this.store.get_token } }).then((res) => {
        ...
        EditStore(id) {
            ...
            axios.get(`api/ProList/edit/${id}`, { headers: { Authorization: 'Bearer ' + this.store.get_token } }).then((res) => {
        ...
        DeleteStore(id) {
            this.$swal({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.delete(`api/ProList/delete/${id}`, { headers: { Authorization: 'Bearer ' + this.store.get_token } }).then((res) => {
        ...
        GetStore(page) {
            axios.get(`api/ProList?page=${page}&sort=${this.Sort}&perpage=${this.PerPage}&search=${this.Search}`, this.FormStore, { headers: { "content-type": "multipart/form-data", Authorization: 'Bearer ' + this.store.get_token } }).then((res) => {
